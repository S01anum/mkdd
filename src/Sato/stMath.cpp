...
bool stSearchInSurface(const TVec3f &vec1, const TVec3f &vec2, const TVec3f &vec3)
{
    bool ret = false;
...
bool stSearchInSurface(const TVec3f &vec, const stPlaneParam &planeparam)
{
    bool ret = false;
...
bool stCollideSurfaceAndSphere(const TVec3f &vec, float radiusSq, const stPlaneParam &planeparam, float &depthSq)
{
    bool collides = false;
